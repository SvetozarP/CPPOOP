...
protected:
	virtual void move() override {
		...
		this->setPosition(Position(this->getPosition().getRow() + rowMove, this->getPosition().getCol() + colMove));
...
public:
	Cat(Position p) 
		: Organism("cat", p), 
		actsPerMove(NOT_MOVING_ACTS), actsSinceLastMove(0), actsInCurrentState(0) {}
